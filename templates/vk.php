...
<a class="resp-sharing-button__link" href="http://vk.com/share.php?title=<?php echo $description ?>&amp;url=<?php echo $url ?>" target="_blank" aria-label="<?php echo $title ?>">
  <div class="resp-sharing-button resp-sharing-button--vk resp-sharing-button--<?php echo $size ?>"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--<?php echo $style ?>">
    <?php if ($style == 'solid'): ?>
